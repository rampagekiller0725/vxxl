...
const Settings = () => {
  const {clear}: any = useContext(MeContext);
  const { authorize, setAuthMethod }: any = useAuthorize()
    ...
    <Layer>
      <View style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('RecoveryKey' as never)}>
          ...
          <TouchableOpacity
            onPress={() => navigation.navigate('AuthorizationMethodSettings' as never)}>
            <View style={styles.box}>
