  ...
  return (
    <Tab.Navigator initialRouteName="Wallet" screenOptions={{
      ...
      <Tab.Screen name="Wallet" component={WalletStack} options={{
				...
				tabBarIcon: ({color, focused}: any) => focused ? <WalletIconActive style={styles.img} /> : <WalletIcon style={styles.img} />
      }} />

      <Tab.Screen name="Settings" component={SettingsStack} options={{
				tabBarShowLabel: true,
				tabBarIcon: ({color, focused}: any) => focused ? <SettingsIconActive style={styles.img} /> : <SettingsIcon style={styles.img} />
			}} />
    </Tab.Navigator>
  );
};
